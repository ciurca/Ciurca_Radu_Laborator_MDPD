...
namespace Ciurca_Radu_Lab2.Migrations
{
    ...
    [Migration("20231106070933_DBContextMemberBorrowing2")]
    partial class DBContextMemberBorrowing2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ciurca_Radu_Lab2.Models.Borrowing", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ciurca_Radu_Lab2.Models.Member", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ciurca_Radu_Lab2.Models.Book", b =>
                {
                    b.HasOne("Ciurca_Radu_Lab2.Models.Author", "Author")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Ciurca_Radu_Lab2.Models.Borrowing", b =>
                {
                    b.HasOne("Ciurca_Radu_Lab2.Models.Book", "Book")
                        .WithOne("Borrowing")
                        .HasForeignKey("Ciurca_Radu_Lab2.Models.Borrowing", "BookID");

                    b.HasOne("Ciurca_Radu_Lab2.Models.Member", "Member")
                        .WithMany("Borrowings")
